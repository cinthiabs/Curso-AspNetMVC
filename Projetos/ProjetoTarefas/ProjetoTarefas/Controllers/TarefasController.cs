...
namespace ProjetoTarefas.Controllers
{
    public class TarefasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TarefasId,Nome,Descrica,Inicio,Fim,Importancia")] Tarefas tarefas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TarefasId,Nome,Descrica,Inicio,Fim,Importancia")] Tarefas tarefas)
        {
